...
def save_checkpoint(
    ...
    path = tl.ik_checkpoint_path(path, ae_cfg.run_name)
    path.parent.mkdir(parents=True, exist_ok=True)
    torch.save(
        {
...
def train(args: argparse.Namespace) -> None:
    ...
    if args.pose_representation:
        locomotion_cfg.pose_representation = args.pose_representation
    ...
    if init_prior_path is not None:
        ...
        ae_cfg = tae.AEConfig(
            ...
            pose_representation=locomotion_cfg.pose_representation,
        )
    ...
    ae_cfg.pose_representation = locomotion_cfg.pose_representation
...
def main() -> None:
    ...
    parser.add_argument("--pose-representation", choices=("rot6", "ik_markers"), default="")
